      ...
      <table className="table">
        ...
        <tbody>
          <tr>
            ...
            <td>7/12/2024</td>
            <td>
              <span className="label label-pending">Pending</span></td>
            <td>
          ...
          <tr>
            ...
            <td>7/24/2024</td>
            <td>
              <span className="label label-approved">Approved</span></td>
            <td>
              <span className="actions">
              <BsFillTrashFill className="delete-btn"/>
                <BsFillPencilFill/>
          ...
          <tr>
            ...
            <td>7/30/2024</td>
            <td>
              <span className="label label-rejected">Rejected</span></td>
            <td>
              <span className="actions">
                <BsFillTrashFill className="delete-btn"/>
                <BsFillPencilFill/>
